...
#define AUX_SAVE_OUTLET_STATES_AS_DEFAULT_PROEPRTY_NAME				"AUX_SAVE_OUTLET_STATES_AS_DEFAULT"
...
typedef enum {
	...
	INDIGO_POLAR_ALIGN_REFERENCE_1,
	INDIGO_POLAR_ALIGN_REFERENCE_2,
	INDIGO_POLAR_ALIGN_REFERENCE_3,
	INDIGO_POLAR_ALIGN_RECALCULATE,
	INDIGO_POLAR_ALIGN_IN_PROGRESS
} platesolver_pa_state_t;

typedef enum {
	INDIGO_SOLVER_STATE_IDLE = 0,
	INDIGO_SOLVER_STATE_WAITING_FOR_IMAGE,
	INDIGO_SOLVER_STATE_SOLVING,
	INDIGO_SOLVER_STATE_SYNCING,
	INDIGO_SOLVER_STATE_CENTERING,
